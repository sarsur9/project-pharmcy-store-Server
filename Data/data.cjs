...
const popularProducts =[
      ...
      },
      {
        ...
        "title": "Augmentin ",
        "category": "Prescriptiom Medicine",
        "desc": "Antibiotics",
        "size": ["1g"],
        "price": "18"
      },
...
PopularProduct.insertMany(popularProducts)
  .then(() => {
    console.log("Popular products inserted");
    mongoose.connection.close(); // Close the connection after all inserts
  })
  .catch((err) => console.error("Error inserting popular products:", err));